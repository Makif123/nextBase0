...
Feature: User should be able to join groups
  ...
  @workGroups
  Scenario Outline: Verify that HR, Helpdesk and Marketing user should be able to join groups

        #Scenario: HR user Marketing user and Helpdesk user, join groups
